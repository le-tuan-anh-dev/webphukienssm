    ...
    <div class="container">
        ...
        <form action="index.php?act=updatedm" method="POST">
            <div class="form-group">
                ...
                <input type="text" id="maloai" name="maloai" disabled value="<?php echo $id ?>">
            </div>
            <div class="form-group">
                <label for="tenloai">Tên loại</label>
                <input type="text" id="tenloai" name="tenloai" value="<?php echo $name ?>">
            </div>
            <div class="form-group d-flex">
                <input type="hidden" name="id_dm" value="<?php if(isset($id) && $id >0) echo $id;?>">
                <input type="submit" name="capnhat" value="CẬP NHẬT">
                <input type="reset" value="NHẬP LẠI">
                <a href="index.php?act=danh_muc">
