<?php
function insert_sanpham($tensp, $giasp, $hinh, $mota,$luot_xem, $iddm)
{
    $sql = " INSERT INTO sanpham(name,price,img,mota,luotxem,iddm) VALUES('$tensp','$giasp','$hinh','$mota','$luot_xem','$iddm')";
    pdo_execute($sql);
}
